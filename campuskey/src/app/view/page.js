    ...
    <div>
      ...
      <div>
        <div className="residents-details p-2 relative">
          <h1 className="text-2xl font-bold ">Gunda Student Boarding House</h1>
        ...
        <div className="flex flex-row justify-around p-4">
          <div className="w-2/4 ">
            ...
            This student-friendly accommodation offers a safe, convenient, and comfortable living environment close to campus. 
            Each unit is fully furnished with essential amenities, including Wi-Fi, a study desk, and a bed.
             The property is managed by trusted landlords and verified by CampusKey to ensure quality and reliability.
              Whether you're looking for privacy or shared living, this option supports your academic journey with peace of mind
            </p>
          </div>
      ...
      <CardHeader>
        ...
        <CardDescription>Read Terms and Conditions , before appying</CardDescription>
      </CardHeader>
